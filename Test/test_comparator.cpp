...
int main()
{
	...
	File_Reader Fr_s("../Data/SLE_Solutions.txt");
	File_Reader Fr_g("../Data/Golden.txt");
	File_Writer Fw("../Data/result_test_comparator.txt");
	...
	std::cout << "\nTest results are presented in \"result_test_comparator.txt\" file (folder Data).\n";
	return 0;
}
